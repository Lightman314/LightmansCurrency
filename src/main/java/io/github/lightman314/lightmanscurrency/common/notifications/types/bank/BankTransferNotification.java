...
public class BankTransferNotification extends Notification {
	...
	protected void saveAdditional(CompoundTag compound) {
		...
		compound.putString("Account", EasyText.Serializer.toJson(this.accountName));
		compound.putString("Other", EasyText.Serializer.toJson(this.otherAccount));
	...
	protected void loadAdditional(CompoundTag compound) {
		...
		this.accountName = EasyText.Serializer.fromJson(compound.getString("Account"));
		this.otherAccount = EasyText.Serializer.fromJson(compound.getString("Other"));
