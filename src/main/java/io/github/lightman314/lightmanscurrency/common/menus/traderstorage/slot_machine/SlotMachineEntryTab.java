        ...
        if(entry != null)
        {
            ...
            if(this.isClient())
            {
                this.menu.SendMessage(this.builder()
                        ...
                        .setCompound("ChangeIcon",icon.save(this.registryAccess())));
            }
        }
    }
    ...
    public void receiveMessage(LazyPacketData message) {
        ...
        if(message.contains("EditEntry"))
        {
            ...
            if(message.contains("AddItem"))
                ...
                this.ChangeEntryCustomIcon(entryIndex,message.getInt("IconIndex"),IconData.load(message.getNBT("ChangeIcon"),this.registryAccess()));
        }
    }
