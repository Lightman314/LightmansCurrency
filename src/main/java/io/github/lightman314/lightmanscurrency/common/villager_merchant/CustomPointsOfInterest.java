...
public class CustomPointsOfInterest {
	...
	public static final ResourceKey<PoiType> BANKER_KEY = ResourceKey.create(Registries.POINT_OF_INTEREST_TYPE, VersionUtil.lcResource("banker"));
	public static final Supplier<PoiType> CASHIER;
	public static final ResourceKey<PoiType> CASHIER_KEY = ResourceKey.create(Registries.POINT_OF_INTEREST_TYPE, VersionUtil.lcResource("cashier"));
