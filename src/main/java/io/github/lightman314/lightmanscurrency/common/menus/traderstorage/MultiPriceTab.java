...
import io.github.lightman314.lightmanscurrency.client.gui.screen.inventory.traderstorage.MultiPriceClientTab;
...
public class MultiPriceTab extends TraderStorageTab {
    ...
    @Override
    public void onTabClose() { this.menu.SetCoinSlotsActive(true); this.selectedTrades.clear(); }
