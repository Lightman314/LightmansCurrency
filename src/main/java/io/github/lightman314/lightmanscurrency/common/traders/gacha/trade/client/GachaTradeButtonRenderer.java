package io.github.lightman314.lightmanscurrency.common.traders.gacha.trade.client;
...
public class GachaTradeButtonRenderer extends TradeRenderManager<GachaDummyTrade> {

    public GachaTradeButtonRenderer(GachaDummyTrade trade) { super(trade); }
