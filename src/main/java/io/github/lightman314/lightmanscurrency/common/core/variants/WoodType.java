...
public class WoodType implements IOptionalKey {
    ...
    public static final WoodType OAK = new WoodType("oak", MaterialColor.WOOD);
    public static final WoodType SPRUCE = new WoodType("spruce", MaterialColor.PODZOL);
    public static final WoodType BIRCH = new WoodType("birch", MaterialColor.SAND);
    public static final WoodType JUNGLE = new WoodType("jungle", MaterialColor.DIRT);
    public static final WoodType ACACIA = new WoodType("acacia", MaterialColor.COLOR_ORANGE);

    public static final WoodType DARK_OAK = new WoodType("dark_oak", MaterialColor.COLOR_BROWN);
    public static final WoodType CRIMSON = new WoodType("crimson", MaterialColor.CRIMSON_STEM);
    public static final WoodType WARPED = new WoodType("warped", MaterialColor.WARPED_STEM);
    ...
    protected WoodType(@Nonnull String name, @Nonnull MaterialColor mapColor) { this.name = name; this.mapColor = mapColor; ALL_TYPES.add(this); }
    protected WoodType(@Nonnull String name, @Nonnull MaterialColor mapColor, @Nonnull WoodData data) { this(name, mapColor); WoodDataHelper.register(this, data); }
    ...
    public static ImmutableList<WoodType> allValues() { return ImmutableList.copyOf(ALL_TYPES); }
