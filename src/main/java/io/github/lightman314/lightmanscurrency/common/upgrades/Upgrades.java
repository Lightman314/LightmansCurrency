...
public class Upgrades {
    ...
    public static final UpgradeType.Simple NETWORK = new UpgradeType.Simple(LCText.TOOLTIP_UPGRADE_NETWORK.get()).withTarget(LCText.TOOLTIP_UPGRADE_TARGET_TRADER_NOT_NETWORK.get());
