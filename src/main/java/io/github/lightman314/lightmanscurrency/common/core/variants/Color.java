...
public enum Color {
    ...
    LIGHT_GRAY(1, 0x9D9D97, MapColor.COLOR_LIGHT_GRAY, Tags.Items.DYES_LIGHT_GRAY, "lightgray"),
    ...
    LIGHT_BLUE(11, 0x00FFFF, MapColor.COLOR_LIGHT_BLUE, Tags.Items.DYES_LIGHT_BLUE, "lightblue"),
    ...
    Color(int sortIndex, int hexColor, MapColor mapColor, TagKey<Item> dyeTag, String deprecatedName) { this.sortIndex = sortIndex; this.hexColor = hexColor; this.mapColor = mapColor; this.dyeTag = dyeTag; this.deprecatedName = deprecatedName; }
    Color(int sortIndex, int hexColor, MapColor mapColor, TagKey<Item> dyeTag) { this(sortIndex, hexColor, mapColor, dyeTag, null); }
