...
public class NonEmptyContainer implements Container {
    ...
    public void save(@Nonnull CompoundTag tag, @Nonnull String key, @Nonnull HolderLookup.Provider lookup) { InventoryUtil.saveAllItems(key,tag,this,lookup); }
    public static NonEmptyContainer load(@Nonnull CompoundTag tag, @Nonnull String key, @Nonnull HolderLookup.Provider lookup) { return new NonEmptyContainer(InventoryUtil.loadAllItems(key,tag,tag.getList(key, Tag.TAG_COMPOUND).size(),lookup)); }
