...
public class ConfiguredTradeMod extends VillagerTradeMod {
    ...
    private String getType(@Nullable Entity villager)
    {
        if(villager instanceof Villager v)
        {
            ...
            if(d != null)
            {
                ...
                if(t != null)
                    return Registry.VILLAGER_TYPE.getKey(t).toString();
            }
        }
        return null;
    }
    ...
    public static final class ModBuilder
    {
        ...
        @Nonnull
        public ModBuilder costForRegion(@Nonnull VillagerType type, @Nonnull Supplier<? extends ItemLike> costReplacement) { return this.costForRegion(Registry.VILLAGER_TYPE.getKey(type),costReplacement); }
        ...
        @Nonnull
        public ModBuilder resultForRegion(@Nonnull VillagerType type, @Nonnull Supplier<? extends ItemLike> resultReplacement) { return this.resultForRegion(Registry.VILLAGER_TYPE.getKey(type),resultReplacement); }
        @Nonnull
        ...
        @Nonnull
        public ModBuilder bothForRegion(@Nonnull VillagerType type, @Nonnull Supplier<? extends ItemLike> replacement) { return this.bothForRegion(Registry.VILLAGER_TYPE.getKey(type),replacement); }
        @Nonnull
