...
public class ItemListingSerializer {
    ...
    public static <L extends ItemListing,T extends IItemListingSerializer & IItemListingDeserializer> void registerItemListing(ResourceLocation type, Class<L> clazz, T serializer) { registerItemListing(type, clazz, serializer, serializer); }

    public static <T extends ItemListing> void registerItemListing(ResourceLocation type, Class<T> clazz, IItemListingSerializer serializer, IItemListingDeserializer deserializer) {
