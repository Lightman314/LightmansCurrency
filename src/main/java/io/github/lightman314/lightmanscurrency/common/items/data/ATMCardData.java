...
public record ATMCardData(Optional<BankReference> bankReference, int validation, boolean locked) {
    ...
    public static final Codec<ATMCardData> CODEC = RecordCodecBuilder.create(builder ->
            builder.group(BankReference.CODEC.optionalFieldOf("Account").forGetter(ATMCardData::bankReference),
    ...
    @Nullable
    public BankReference getBankReference(IClientTracker parent) { return this.getBankReference(parent.isClient()); }
    @Nullable
