...
public class ATMData extends ServerToClientPacket {
	...
	private static ATMData generateDefault() { return new ATMData(ATMExchangeButtonData.generateDefault()); }
	...
	@SubscribeEvent
	public static void serverStarted(ServerStartedEvent event) { get(); }

	@SubscribeEvent
	public static void onPlayerLogin(PlayerEvent.PlayerLoggedInEvent event) {
		//Send the ATM data to the player
		get().sendTo(event.getEntity());
	}
