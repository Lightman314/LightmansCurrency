...
public class SalaryPaymentNotification extends Notification {
    ...
    protected void saveAdditional(CompoundTag compound, HolderLookup.Provider lookup) {
        ...
        compound.putString("SalaryName",Component.Serializer.toJson(this.salaryName,lookup));
        compound.put("Salary",this.salaryAmount.save());
        compound.put("Total",this.totalAmount.save());
        compound.put("Targets",TagUtil.writeStringList(this.targetAccounts.stream().map(c -> Component.Serializer.toJson(c,lookup)).toList()));
    }
