...
public class ItemWriteData
{
    ...
    public Component format() { return EasyText.translatable("log.shoplog.item.itemformat", this.count, this.itemName); }

    public Component formatWith(Component other) { return EasyText.translatable("log.shoplog.and", this.format(), other); }

    public Component formatWith(ItemWriteData other) { return EasyText.translatable("log.shoplog.and", this.format(), other.format()); }
