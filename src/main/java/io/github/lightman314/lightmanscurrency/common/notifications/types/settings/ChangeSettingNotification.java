...
public abstract class ChangeSettingNotification extends Notification {
	...
	public static class Advanced extends ChangeSettingNotification
	{
		...
		public Advanced(CompoundTag compound) { this.load(compound); }
		
		@Override
		protected ResourceLocation getType() { return ADVANCED_TYPE; }

		@Override
		public MutableComponent getMessage() { return new TranslatableComponent("log.settings.change", this.player.lastKnownName(), this.setting, this.oldValue, this.newValue); }
	...
	public static class Simple extends ChangeSettingNotification
	{
		...
		public Simple(CompoundTag compound) { this.load(compound); }
		...
		public MutableComponent getMessage() {
			return new TranslatableComponent("log.settings.change.simple", this.player.lastKnownName(), this.setting, this.newValue);
		}
