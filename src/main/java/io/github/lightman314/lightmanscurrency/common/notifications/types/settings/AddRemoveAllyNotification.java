...
public class AddRemoveAllyNotification extends Notification {
	...
	public static final NotificationType<AddRemoveAllyNotification> TYPE = new NotificationType<>(new ResourceLocation(LightmansCurrency.MODID, "add_remove_ally"),AddRemoveAllyNotification::new);
