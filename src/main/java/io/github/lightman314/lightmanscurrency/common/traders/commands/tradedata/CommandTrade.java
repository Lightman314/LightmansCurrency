...
public class CommandTrade extends TradeData {
    ...
    @Nonnull
    public static CommandTrade loadData(CompoundTag tag, boolean validateRules, @Nonnull HolderLookup.Provider lookup)
    {
    ...
    @Override
    protected void loadFromNBT(CompoundTag tag, @Nonnull HolderLookup.Provider lookup) {
