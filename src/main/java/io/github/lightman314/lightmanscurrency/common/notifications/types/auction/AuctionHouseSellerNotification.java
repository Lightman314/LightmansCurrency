...
public class AuctionHouseSellerNotification extends AuctionHouseNotification{
	...
	public AuctionHouseSellerNotification(CompoundNBT compound) { this.load(compound); }
	...
	public IFormattableTextComponent getMessage() {
		...
		return EasyText.translatable("notifications.message.auction.seller", this.customer, itemText, cost);
