package io.github.lightman314.lightmanscurrency.common.traders.item.tabs.ticket;

import io.github.lightman314.lightmanscurrency.api.network.LazyPacketData;
import io.github.lightman314.lightmanscurrency.api.traders.menu.storage.ITraderStorageMenu;
import io.github.lightman314.lightmanscurrency.common.traders.item.client.tabs.ticket.ItemTradeTicketEditClientTab;
...
public class ItemTradeTicketEditTab extends ItemTradeEditTab {
    ...
    public void ChangeRecipe(@Nullable ResourceLocation recipe, int index)
    {
        ...
        if(trade != null)
        {
            TicketSaleData data = trade.getTicketData(index);
            if(data == null)
                return;
