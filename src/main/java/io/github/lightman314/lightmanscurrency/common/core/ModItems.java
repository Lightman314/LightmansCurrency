...
public class ModItems {
	...
	static {
		...
		//Wallets
		WALLET_LEATHER = ModRegistries.ITEMS.register("wallet_leather", () -> new WalletItem.Colored(6,WalletItem.lazyModel("wallet_leather"), false, 0, 0, SoundEntry.WALLET_DEFAULT, new Item.Properties()));
