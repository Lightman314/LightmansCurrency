...
public class ModItems {
	...
	static {
		...
		WALLET_IRON = ModRegistries.ITEMS.register("wallet_iron", () -> new WalletItem(1, 12, "wallet_iron", new Item.Properties().tab(ModCreativeGroups.getCoinGroup())));
		WALLET_GOLD = ModRegistries.ITEMS.register("wallet_gold", () -> new WalletItem(2, 18, "wallet_gold", new Item.Properties().tab(ModCreativeGroups.getCoinGroup())));
		WALLET_EMERALD = ModRegistries.ITEMS.register("wallet_emerald", () -> new WalletItem(3, 24, "wallet_emerald", new Item.Properties().tab(ModCreativeGroups.getCoinGroup())));
		WALLET_DIAMOND = ModRegistries.ITEMS.register("wallet_diamond", () -> new WalletItem(4, 30, "wallet_diamond", new Item.Properties().tab(ModCreativeGroups.getCoinGroup())));
		WALLET_NETHERITE = ModRegistries.ITEMS.register("wallet_netherite", () -> new WalletItem(5, 36, "wallet_netherite", new Item.Properties().tab(ModCreativeGroups.getCoinGroup()).fireResistant()));
		
		//Portable Blocks
		PORTABLE_TERMINAL = ModRegistries.ITEMS.register("portable_terminal", () -> new PortableTerminalItem(new Item.Properties().tab(ModCreativeGroups.getMachineGroup())));
		PORTABLE_GEM_TERMINAL = ModRegistries.ITEMS.register("portable_gem_terminal", () -> new PortableTerminalItem(new Item.Properties().tab(ModCreativeGroups.getMachineGroup())));
		...
		SPEED_UPGRADE_2 = ModRegistries.ITEMS.register("speed_upgrade_2", () -> new SpeedUpgradeItem(8, new Item.Properties().tab(ModCreativeGroups.getUpgradeGroup())));
		SPEED_UPGRADE_3 = ModRegistries.ITEMS.register("speed_upgrade_3", () -> new SpeedUpgradeItem(12, new Item.Properties().tab(ModCreativeGroups.getUpgradeGroup())));
		SPEED_UPGRADE_4 = ModRegistries.ITEMS.register("speed_upgrade_4", () -> new SpeedUpgradeItem(16, new Item.Properties().tab(ModCreativeGroups.getUpgradeGroup())));
		...
		COIN_CHEST_BANK_UPGRADE = ModRegistries.ITEMS.register("coin_chest_bank_upgrade", () -> new UpgradeItem.Simple(UpgradeType.COIN_CHEST_BANK, new Item.Properties()/*.tab(ModCreativeGroups.getUpgradeGroup())*/));
