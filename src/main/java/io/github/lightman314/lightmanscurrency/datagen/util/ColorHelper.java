...
public class ColorHelper {
    ...
    public static ResourceLocation GetWoolTextureOfColor(Color color) { return ResourceLocation.withDefaultNamespace("block/" + color.getResourceSafeName() + "_wool"); }

    public static ResourceLocation GetConcreteTextureOfColor(Color color) { return ResourceLocation.withDefaultNamespace("block/" + color.getResourceSafeName() + "_concrete_powder"); }
