...
public class WoodDataHelper {
    ...
    static {
        ...
        register(WoodType.CHERRY, WoodData.of(Items.CHERRY_LOG, Items.CHERRY_PLANKS, Items.CHERRY_SLAB, "minecraft:block/cherry_log", "minecraft:block/cherry_log_top", "minecraft:block/cherry_planks"));
        register(WoodType.BAMBOO, WoodData.of(Items.BAMBOO_BLOCK, Items.BAMBOO_PLANKS, Items.BAMBOO_SLAB, "minecraft:block/bamboo_block", "minecraft:block/bamboo_block_top", "minecraft:block/bamboo_planks"));
    ...
    public static void register(@Nonnull WoodType type, @Nonnull WoodData data) {
        ...
        {
            LightmansCurrency.LogError("Attempted to registerNotification a duplicate WoodData for type '" + type.id + "'!");
            return;
        }
