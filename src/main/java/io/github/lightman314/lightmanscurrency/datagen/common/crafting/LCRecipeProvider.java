...
public class LCRecipeProvider extends RecipeProvider {
    ...
    public LCRecipeProvider(DataGenerator gen) { super(gen); }
    ...
    protected void buildCraftingRecipes(@Nonnull Consumer<FinishedRecipe> consumer) {
        ...
        ConditionalRecipe.Builder conditional;

        //Register Crafting Conditions
        LCCraftingConditions.register();

        //Trading Core
        ShapedRecipeBuilder.shaped(ModItems.TRADING_CORE.get())
        ...
        //Gem Terminal
        ShapedRecipeBuilder.shaped(ModBlocks.GEM_TERMINAL.get())
                .unlockedBy("money", MoneyKnowledge())
                .unlockedBy("trader", TraderKnowledge())
                .pattern("aaa")
                .pattern("aea")
        ...
        //Cash Register
        ShapedRecipeBuilder.shaped(ModBlocks.CASH_REGISTER.get())
                .unlockedBy("money", MoneyKnowledge())
                .unlockedBy("trader", TraderKnowledge())
                .pattern("iii")
                .pattern("ede")
        ...
        //Coin Chest
        conditional = ConditionalRecipe.builder().addCondition(LCCraftingConditions.CoinChest.INSTANCE);
        ShapedRecipeBuilder.shaped(ModBlocks.COIN_CHEST.get())
                .unlockedBy("money", MoneyKnowledge())
                .pattern("ppp")
                .pattern("prp")
                .pattern("ppp")
        ...
        //Trader Recipes
        //Display Case
        ShapedRecipeBuilder.shaped(ModBlocks.DISPLAY_CASE.get())
                .unlockedBy("money", MoneyKnowledge())
                .unlockedBy("trader", TraderKnowledge())
                .pattern("g")
                .pattern("x")
        ...
        //Vending Machine
        ShapedRecipeBuilder.shaped(ModBlocks.VENDING_MACHINE.get(Color.WHITE))
                .unlockedBy("money", MoneyKnowledge())
                .unlockedBy("trader", TraderKnowledge())
                .pattern("igi")
                .pattern("igi")
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.VENDING_MACHINE_LARGE.get(Color.WHITE))
                .unlockedBy("money", MoneyKnowledge())
                .unlockedBy("trader", TraderKnowledge())
        ...
        ModBlocks.SHELF.forEach((woodType,shelf) -> {
            ...
            ItemLike slab = data == null ? null : data.getSlab();
            if(slab != null)
            {
                ResourceLocation id = WoodID("traders/shelf/", woodType);
                ShapedRecipeBuilder.shaped(ModBlocks.SHELF.get(woodType))
                        .group("shelf_trader")
                        .unlockedBy("money", MoneyKnowledge())
                        .unlockedBy("trader", TraderKnowledge())
                        .pattern("x").pattern("s")
                ...
                if(tempConditional != null)
                    tempConditional .generateAdvancement(AddPrefix(id,ADV_PREFIX)).build(consumer, id);
            }
            else
        ...
        ModBlocks.CARD_DISPLAY.forEach((woodType,card_display) -> {
            ...
            Consumer<FinishedRecipe> c = tempConditional == null ? consumer : tempConditional::addRecipe;
            WoodData data = woodType.getData();
            ItemLike log = data == null ? null : data.getLog();
            if(log != null)
            {
                ResourceLocation id = WoodID("traders/card_display/", woodType);
                ShapedRecipeBuilder.shaped(ModBlocks.CARD_DISPLAY.get(woodType))
        ...
        for(Color c : Color.values())
        {
            ...
            ShapedRecipeBuilder.shaped(ModBlocks.FREEZER.get(c))
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.ITEM_NETWORK_TRADER_1.get())
        ...
        conditional.generateAdvancement(AddPrefix(ID("network/item_network_trader_1"),ADV_PREFIX)).build(consumer, ID("network/item_network_trader_1"));

        //T2
        conditional = ConditionalRecipe.builder().addCondition(LCCraftingConditions.NetworkTrader.INSTANCE);
        ShapedRecipeBuilder.shaped(ModBlocks.ITEM_NETWORK_TRADER_2.get())
                .group("item_network_trader")
                .unlockedBy("money", MoneyKnowledge())
                .unlockedBy("trader", TraderKnowledge())
                .unlockedBy("terminal", LazyTrigger(LCTags.Items.NETWORK_TERMINAL))
                ...
                .define('c', Tags.Items.CHESTS_WOODEN)
                .save(conditional::addRecipe);
        conditional.generateAdvancement(AddPrefix(ID("network/item_network_trader_2"),ADV_PREFIX)).build(consumer, ID("network/item_network_trader_2"));

        //T3
        conditional = ConditionalRecipe.builder().addCondition(LCCraftingConditions.NetworkTrader.INSTANCE);
        ShapedRecipeBuilder.shaped(ModBlocks.ITEM_NETWORK_TRADER_3.get())
                .group("item_network_trader")
                .unlockedBy("money", MoneyKnowledge())
                .unlockedBy("trader", TraderKnowledge())
                .unlockedBy("terminal", LazyTrigger(LCTags.Items.NETWORK_TERMINAL))
                ...
                .define('c', Tags.Items.CHESTS_WOODEN)
                .save(conditional::addRecipe);
        conditional.generateAdvancement(AddPrefix(ID("network/item_network_trader_3"),ADV_PREFIX)).build(consumer, ID("network/item_network_trader_3"));

        //T4
        conditional = ConditionalRecipe.builder().addCondition(LCCraftingConditions.NetworkTrader.INSTANCE);
        ShapedRecipeBuilder.shaped(ModBlocks.ITEM_NETWORK_TRADER_4.get())
                .group("item_network_trader")
                .unlockedBy("money", MoneyKnowledge())
                .unlockedBy("trader", TraderKnowledge())
                .unlockedBy("terminal", LazyTrigger(LCTags.Items.NETWORK_TERMINAL))
                ...
                .define('c', Tags.Items.CHESTS_WOODEN)
                .save(conditional::addRecipe);
        conditional.generateAdvancement(AddPrefix(ID("network/item_network_trader_4"),ADV_PREFIX)).build(consumer, ID("network/item_network_trader_4"));

        //Specialty Traders
        //Armor Display
        ShapedRecipeBuilder.shaped(ModBlocks.ARMOR_DISPLAY.get())
                .unlockedBy("money", MoneyKnowledge())
                .unlockedBy("trader", TraderKnowledge())
                .pattern("ggg")
                .pattern("gag")
        ...
        //Ticket Kiosk
        ShapedRecipeBuilder.shaped(ModBlocks.TICKET_KIOSK.get())
                .unlockedBy("money", MoneyKnowledge())
                .unlockedBy("trader", TraderKnowledge())
                .pattern("iii")
                .pattern("igi")
        ...
        ModBlocks.BOOKSHELF_TRADER.forEach((woodType,bookshelf) -> {
            ...
            Consumer<FinishedRecipe> c = tempConditional == null ? consumer : tempConditional::addRecipe;
            WoodData data = woodType.getData();
            ItemLike plank = data == null ? null : data.getPlank();
            ItemLike slab = data == null ? null : data.getSlab();
            if(plank != null && slab != null)
            {
                ResourceLocation id = WoodID("traders/bookshelf/", woodType);
                ShapedRecipeBuilder.shaped(ModBlocks.BOOKSHELF_TRADER.get(woodType))
        ...
        //Slot Machine
        ShapedRecipeBuilder.shaped(ModBlocks.SLOT_MACHINE.get())
                .unlockedBy("money", MoneyKnowledge())
                .unlockedBy("trader", TraderKnowledge())
                .pattern("igi")
                .pattern("idi")
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.ITEM_TRADER_INTERFACE.get())
                .unlockedBy("money", MoneyKnowledge())
                .unlockedBy("trader", TraderKnowledge())
                .unlockedBy("terminal", LazyTrigger(LCTags.Items.NETWORK_TERMINAL))
                .pattern("ici")
                ...
                .define('c', Tags.Items.CHESTS_WOODEN)
                .save(conditional::addRecipe);
        conditional.generateAdvancement(AddPrefix(ItemID(ModBlocks.ITEM_TRADER_INTERFACE),ADV_PREFIX)).build(consumer, ItemID(ModBlocks.ITEM_TRADER_INTERFACE));
        ...
        ModBlocks.AUCTION_STAND.forEach((woodType, auction_stand) -> {
            ...
            if(log != null)
            {
                ...
                ShapedRecipeBuilder.shaped(ModBlocks.AUCTION_STAND.get(woodType))
                        .group("auction_stand")
                        .unlockedBy("money", MoneyKnowledge())
                        .unlockedBy("trader", TraderKnowledge())
                        .unlockedBy("terminal", LazyTrigger(LCTags.Items.NETWORK_TERMINAL))
        ...
        //Coin Jars
        //Piggy Bank
        ShapedRecipeBuilder.shaped( ModBlocks.PIGGY_BANK.get())
                .unlockedBy("money", MoneyKnowledge())
        ...
        //Blue
        ShapedRecipeBuilder.shaped(ModBlocks.COINJAR_BLUE.get())
                .unlockedBy("money", MoneyKnowledge())
                .unlockedBy("wallet", LazyTrigger(LCTags.Items.WALLET))
                .pattern("b b")
                .pattern("bdb")
        ...
        conditional.generateAdvancement(AddPrefix(ItemID("upgrades/", ModItems.COIN_CHEST_EXCHANGE_UPGRADE),ADV_PREFIX)).build(consumer, ItemID("upgrades/", ModItems.COIN_CHEST_EXCHANGE_UPGRADE));
        ...
        UpgradeRecipeBuilder.smithing(
                ...
                .unlocks("coin_chest", LazyTrigger(ModBlocks.COIN_CHEST))
                .save(conditional::addRecipe, "null:null");
        conditional.generateAdvancement(AddPrefix(ItemID("upgrades/", ModItems.COIN_CHEST_BANK_UPGRADE),ADV_PREFIX)).build(consumer, ItemID("upgrades/", ModItems.COIN_CHEST_BANK_UPGRADE));
        */
        ...
        UpgradeRecipeBuilder.smithing(
                ...
                .unlocks("coin_chest", LazyTrigger(ModBlocks.COIN_CHEST))
                .save(conditional::addRecipe, "null:null");
        conditional.generateAdvancement(AddPrefix(ItemID("upgrades/", ModItems.COIN_CHEST_MAGNET_UPGRADE_1),ADV_PREFIX)).build(consumer, ItemID("upgrades/", ModItems.COIN_CHEST_MAGNET_UPGRADE_1));
        conditional = ConditionalRecipe.builder().addCondition(LCCraftingConditions.CoinChestUpgradeMagnet.INSTANCE);
        UpgradeRecipeBuilder.smithing(
                ...
                .save(conditional::addRecipe, "null:null");
        conditional.generateAdvancement(AddPrefix(ItemID("upgrades/", ModItems.COIN_CHEST_MAGNET_UPGRADE_2),ADV_PREFIX)).build(consumer, ItemID("upgrades/", ModItems.COIN_CHEST_MAGNET_UPGRADE_2));
        conditional = ConditionalRecipe.builder().addCondition(LCCraftingConditions.CoinChestUpgradeMagnet.INSTANCE);
        UpgradeRecipeBuilder.smithing(
                ...
                .save(conditional::addRecipe, "null:null");
        conditional.generateAdvancement(AddPrefix(ItemID("upgrades/", ModItems.COIN_CHEST_MAGNET_UPGRADE_3),ADV_PREFIX)).build(consumer, ItemID("upgrades/", ModItems.COIN_CHEST_MAGNET_UPGRADE_3));
        conditional = ConditionalRecipe.builder().addCondition(LCCraftingConditions.CoinChestUpgradeMagnet.INSTANCE);
        UpgradeRecipeBuilder.smithing(
                ...
                .save(conditional::addRecipe, "null:null");
        conditional.generateAdvancement(AddPrefix(ItemID("upgrades/", ModItems.COIN_CHEST_MAGNET_UPGRADE_4),ADV_PREFIX)).build(consumer, ItemID("upgrades/", ModItems.COIN_CHEST_MAGNET_UPGRADE_4));
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.TAX_COLLECTOR.get())
                .unlockedBy("money", MoneyKnowledge())
                .unlockedBy("trader", TraderKnowledge())
                .pattern("ghg")
                .pattern("nxn")
        ...
        //2.1.2.3
        //The Jar of Sus
        ShapelessRecipeBuilder.shapeless(ModBlocks.SUS_JAR.get())
    ...
    private static void GenerateWalletRecipes(@Nonnull Consumer<FinishedRecipe> consumer, List<Pair<Ingredient, RegistryObject<? extends ItemLike>>> ingredientWalletPairs)
    {
        ...
        for(int w = 0; w < wallets.size(); ++w)
        {
            ...
            ShapelessRecipeBuilder b = ShapelessRecipeBuilder.shapeless(wallets.get(w))
        ...
        for(int w = 0; w < wallets.size() - 1; ++w)
        {
            for(int w2 = w + 1; w2 < wallets.size(); ++w2)
            {
                ...
                WalletUpgradeRecipeBuilder b = WalletUpgradeRecipeBuilder.shapeless(result)
    ...
    {
        ShapelessRecipeBuilder b = ShapelessRecipeBuilder.shapeless(item2)
                .group(group);
    ...
    private static void GenerateColoredDyeAndWashRecipes(@Nonnull Consumer<FinishedRecipe> consumer, RegistryObjectBundle<? extends ItemLike,Color> bundle, ItemLike cleanItem, @Nullable String dyeGroup, String prefix, List<Pair<String, CriterionTriggerInstance>> criteria)
    {
        ...
        //Washing Recipe
        ShapelessRecipeBuilder builder = ShapelessRecipeBuilder.shapeless(cleanItem);
        ApplyCriteria(builder, criteria);
    ...
    private static ResourceLocation WoodID(String prefix, WoodType woodType) { return ID(prefix + (woodType.isModded() ? woodType.getModID() + "/" : "") + woodType.id); }
    private static ResourceLocation ID(String path) { return new ResourceLocation(LightmansCurrency.MODID, path); }

    private static ResourceLocation AddPrefix(ResourceLocation id, String prefix) { return new ResourceLocation(id.getNamespace(), prefix + id.getPath()); }
