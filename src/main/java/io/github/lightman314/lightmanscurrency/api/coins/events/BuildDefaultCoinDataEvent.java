 ...
 */
public final class BuildDefaultCoinDataEvent extends Event {
    ...
    public BuildDefaultCoinDataEvent() { existingEntries.clear(); }
     ...
     */
    @Nullable
    public ChainData.Builder getExistingBuilder(String chain) { return this.builders.get(chain); }

    /**
     * Whether a builder for the given chain has already been registered to this event.
     */
    public boolean exists(String chain) { return this.builders.containsKey(Objects.requireNonNull(chain)); }
    /**
     * Whether the given chain has not yet had any builders registered to this event.
     */
    public boolean available(String chain) { return !this.builders.containsKey(Objects.requireNonNull(chain)); }
     ...
     */
    public void addDefault(ChainData.Builder builder) { this.addDefault(builder, false); }
     ...
     * Check {@link #available(String)} or {@link #exists(String)} to see if a given chain has already been registered.
     */
    public void addDefault(ChainData.Builder builder, boolean allowOverride)
    {
