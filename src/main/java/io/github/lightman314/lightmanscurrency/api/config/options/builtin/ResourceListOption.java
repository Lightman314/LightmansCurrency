...
public class ResourceListOption extends ListOption<ResourceLocation> {
    ...
    protected ResourceListOption(@Nonnull NonNullSupplier<List<ResourceLocation>> defaultValue) { super(defaultValue); }
    @Override
    ...
    public static ResourceListOption create(@Nonnull NonNullSupplier<List<ResourceLocation>> defaultValue) { return new ResourceListOption(defaultValue); }
}
