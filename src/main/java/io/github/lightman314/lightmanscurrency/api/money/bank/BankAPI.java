...
public abstract class BankAPI {
     ...
     */
    public abstract void RegisterReferenceType(BankReferenceType type);
     ...
     */
    @Nullable
    public abstract BankReferenceType GetReferenceType(ResourceLocation type);
     ...
     * @param requestedAmount The amount the player has requested to deposit. If not enough funds are available, the largest available amount will be deposited.
     */
    public abstract void BankDeposit(Player player, Container container, BankReference account, MoneyValue requestedAmount);
     ...
     * @param amount The amount the player has requested to withdraw. If not enough funds are available, the largest available amount will be withdrawn.
     */
    public abstract void BankWithdraw(Player player, Container container, BankReference account, MoneyValue amount);
    ...
    public abstract MutableComponent BankTransfer(IBankAccountAdvancedMenu menu, MoneyValue amount, IBankAccount destination);
    /**
    ...
    public abstract MutableComponent BankTransfer(Player player, BankReference fromAccount, MoneyValue amount, IBankAccount destination);
