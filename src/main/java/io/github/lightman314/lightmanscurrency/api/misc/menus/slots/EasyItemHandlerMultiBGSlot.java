...
public abstract class EasyItemHandlerMultiBGSlot extends EasyItemHandlerSlot {

    public EasyItemHandlerMultiBGSlot(IItemHandlerModifiable container, int slot, int x, int y) { super(container, slot, x, y); }
