...
public class TaxesCollectedNotification extends SingleLineNotification {
    ...
    public static NonNullSupplier<Notification> create(Component taxedName, MoneyValue amount, TaxEntryCategory category) { return () -> new TaxesCollectedNotification(taxedName, amount, category); }
