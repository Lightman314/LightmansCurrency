package io.github.lightman314.lightmanscurrency.api.money.client.input.builtin;
...
public class CoinValueInput extends MoneyInputHandler implements IScrollable {
    ...
    @Override
    public String getUniqueName() { return CoinCurrencyType.getUniqueName(this.chain.chain); }
