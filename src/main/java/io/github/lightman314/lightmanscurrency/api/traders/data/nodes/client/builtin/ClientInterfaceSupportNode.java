...
public class ClientInterfaceSupportNode extends ClientTraderNode<InterfaceSupportNode> implements IClientPermissionProvider {

    public ClientInterfaceSupportNode(InterfaceSupportNode node) { super(node); }

    @Override
    public void addPermissionOptions(TraderData trader, PermissionOptionsBuilder builder) {
        builder.addSimple(Permissions.INTERACTION_LINK);
    }
}
