...
public class ItemIcon extends IconData
{
    ...
    public static final Type TYPE = new Type(VersionUtil.lcResource("item"),ItemIcon::loadIcon,ItemIcon::parseIcon);
    ...
    protected void saveAdditional(CompoundTag tag) {
        tag.put("Item", InventoryUtil.saveItemNoLimits(this.iconStack));
    ...
    protected void writeAdditional(JsonObject json) {
        json.add("Item", FileUtil.convertItemStack(this.iconStack));
        if(this.countTextOverride != null)
    ...
    {
        ItemStack stack = InventoryUtil.loadItemNoLimits(tag.getCompound("Item"));
    ...
    {
        ItemStack stack = FileUtil.parseItemStack(GsonHelper.getAsJsonObject(json,"Item"));
