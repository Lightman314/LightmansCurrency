...
public abstract class EasyButton extends EasyWidget {
    ...
    private final Consumer<EasyButton> pressAction;
    private final Optional<Consumer<EasyButton>> altPressAction;

    protected EasyButton(ButtonBuilder<?,?> builder) {
        super(builder);
    ...
    public static abstract class ButtonBuilder<T extends ButtonBuilder<T,X>,X extends EasyButton> extends Builder<T,X>
    {
        private Consumer<EasyButton> pressAction = b -> {};
        @Nullable
        private Consumer<EasyButton> altPressAction = null;
        ...
        public T onPress(Consumer<EasyButton> action) { this.pressAction = action; return this.getSelf(); }

        public T onAltPress(Runnable action) { return this.onAltPress(b -> action.run()); }
        public T onAltPress(Consumer<EasyButton> action) { this.altPressAction = action; return this.getSelf(); }

    }

    public static abstract class FlexibleSizeButtonBuilder<T extends FlexibleSizeButtonBuilder<T,X>,X extends EasyButton> extends ButtonBuilder<T,X>
    {
