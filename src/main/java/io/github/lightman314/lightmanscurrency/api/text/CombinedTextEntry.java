...
public final class CombinedTextEntry {
    ...
    public void forEachKey(Consumer<String> consumer) { this.keys.forEach(s -> consumer.accept(s.get())); }
    public CombinedTextEntry(List<Supplier<String>> keys) { this.keys = ImmutableList.copyOf(keys); }
