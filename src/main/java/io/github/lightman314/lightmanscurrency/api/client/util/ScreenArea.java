package io.github.lightman314.lightmanscurrency.api.client.util;
...
public final class ScreenArea {
    ...
    public boolean isOutside(ScreenArea area) { return !isMouseInArea(area.pos) || !isMouseInArea(area.pos.offset(area.width,area.height)); }
