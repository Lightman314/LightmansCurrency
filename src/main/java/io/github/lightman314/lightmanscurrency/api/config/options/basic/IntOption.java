...
public class IntOption extends ConfigOption<Integer> {
    ...
    protected IntOption(Supplier<Integer> defaultValue, int lowerLimit, int upperLimit) {
        super(defaultValue);
    ...
    @Override
    public boolean allowedValue(Integer newValue) { return newValue >= this.lowerLimit && newValue <= this.upperLimit; }
    ...
    public static IntOption create(Supplier<Integer> defaultValue) { return new IntOption(defaultValue, Integer.MIN_VALUE, Integer.MAX_VALUE); }
    public static IntOption create(Supplier<Integer> defaultValue, int lowerLimit) { return new IntOption(defaultValue, lowerLimit, Integer.MAX_VALUE); }
    public static IntOption create(Supplier<Integer> defaultValue, int lowerLimit, int upperLimit) { return new IntOption(defaultValue, lowerLimit, upperLimit); }
