...
public class MultiMoneyStat extends StatType<MoneyView,MoneyValue> {
    ...
    public static final ResourceLocation TYPE = new ResourceLocation(MoneyAPI.MODID,"multi_money");
    ...
    protected static class MMInstance extends Instance<MoneyView,MoneyValue>
    {
        ...
        @Override
        protected void saveAdditional(@Nonnull CompoundTag tag) { tag.put("Value",this.data.save()); }
        @Override
        public void load(@Nonnull CompoundTag tag) { this.data.load(tag.getList("Value", Tag.TAG_COMPOUND)); }
        @Override
