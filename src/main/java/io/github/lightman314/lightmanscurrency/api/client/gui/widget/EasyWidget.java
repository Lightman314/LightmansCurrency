...
public abstract class EasyWidget extends AbstractWidget implements IRenderTick {
    ...
    //Easy Widget data
    private final Function<EasyWidget,Boolean> activeCheck;
    private final Function<EasyWidget,Boolean> visibleCheck;
    private final TooltipSource tooltip;

    protected EasyWidget(Builder<?,?> builder)
    {
    ...
    private ClientTooltipPositioner getTooltipPositioner()
    {
    ...
    public static abstract class Builder<T extends Builder<T,X>,X extends EasyWidget>
    {
        private ScreenArea area;
        private Component message = Component.empty();
        private Function<EasyWidget,Boolean> activeCheck = EasyWidget::isActive;
        private Function<EasyWidget,Boolean> visibleCheck = w -> w.visible;
        ...
        public final T active1(Function<EasyWidget,Boolean> active) { this.activeCheck = active; return this.getSelf(); }
        ...
        public final T visible1(Function<EasyWidget,Boolean> visible) { this.visibleCheck = visible; return this.getSelf(); }
    ...
    public static abstract class FlexibleSizeBuilder<T extends FlexibleSizeBuilder<T,X>,X extends EasyWidget> extends Builder<T,X>
    {
