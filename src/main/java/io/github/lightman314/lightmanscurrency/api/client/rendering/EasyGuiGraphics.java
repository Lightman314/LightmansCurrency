package io.github.lightman314.lightmanscurrency.api.client.rendering;
...
public final class EasyGuiGraphics {
    ...
    public void drawString(String text, int x, int y, int color, boolean shadow) { this.gui.drawString(this.font, text, this.offset.x + x, this.offset.y + y, color, shadow); }
    public void drawString(String text, ScreenPosition pos, int color) { this.drawString(text, pos.x, pos.y, color); }
    public void drawString(String text, ScreenPosition pos, int color, boolean shadow) { this.drawString(text, pos.x, pos.y, color, shadow); }
    ...
    public void drawString(Component text, int x, int y, int color, boolean shadow) { this.gui.drawString(this.font, text, this.offset.x + x, this.offset.y + y, color, shadow); }
    public void drawString(Component text, ScreenPosition pos, int color) { this.drawString(text, pos.x, pos.y, color); }
    public void drawString(Component text, ScreenPosition pos, int color, boolean shadow) { this.drawString(text, pos.x, pos.y, color, shadow); }
    ...
    public void drawString(FormattedCharSequence text, int x, int y, int color, boolean shadow) { this.gui.drawString(this.font, text, this.offset.x + x, this.offset.y + y, color, shadow); }
    public void drawString(FormattedCharSequence text, ScreenPosition pos, int color) { this.drawString(text, pos.x, pos.y, color); }
    public void drawString(FormattedCharSequence text, ScreenPosition pos, int color, boolean shadow) { this.drawString(text, pos.x, pos.y, color,shadow); }
