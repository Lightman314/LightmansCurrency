...
public class WildcardSelectorListOption extends ListOption<WildcardTargetSelector> {
    ...
    @Override
    public boolean isValidEntryType(Class<?> clazz) { return clazz == WildcardSelectorListOption.class; }

    public boolean matches(Identifier id) { return this.matches(id.toString()); }
