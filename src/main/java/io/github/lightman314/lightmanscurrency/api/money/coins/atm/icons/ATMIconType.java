...
public final class ATMIconType {
    ...
    public ATMIconData parse(JsonObject data,DataContext<JsonElement> context) throws JsonSyntaxException, ResourceLocationException { return this.deserializer.apply(data,context); }
