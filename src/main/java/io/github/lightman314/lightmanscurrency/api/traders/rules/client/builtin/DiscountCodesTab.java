...
import io.github.lightman314.lightmanscurrency.api.traders.rules.builtin.DiscountCodes;
...
public class DiscountCodesTab extends TradeRuleSubTab<DiscountCodes> implements IScrollable {
    ...
    public DiscountCodesTab(TradeRulesClientTab<?> parent) { super(parent, DiscountCodes.TYPE); }
