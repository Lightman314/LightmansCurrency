package io.github.lightman314.lightmanscurrency.api.money.client.input;
...
public class MoneyValueWidget extends EasyWidgetWithChildren {
    ...
    public static final FixedSizeSprite SPRITE_FREE_TOGGLE = WidgetStateSprite.lazyHoverable(LightmansCurrency.id("common/widgets/button_freetoggle"),10,10);
