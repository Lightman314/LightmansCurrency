...
public class Permissions {
    ...
    /**
     * Not an actual permission that should be granted. Primarly used to debug attempts to access admin-only settings without the appropriate permissions on the logical server.
     */
