...
import io.github.lightman314.lightmanscurrency.api.traders.menu.storage.client.builtin.MultiPriceClientTab;
...
public class MultiPriceTab extends TraderStorageTab {
    ...
    public static final ResourceLocation KEY = LightmansCurrency.id("trades_multi_edit");

    public MultiPriceTab(ITraderStorageMenu menu) { super(menu); }
    ...
    @Override
    public Object createClientTab(Object screen) { return new MultiPriceClientTab(screen,this); }

    @Override
    public boolean canOpen(Player player) { return this.menu.hasPermission(Permissions.EDIT_TRADES); }

    public void setPrices(MoneyValue price)
    {
        TraderData trader = this.menu.getTrader();
        if(trader != null)
        {
    ...
    public void OpenMessage(@Nullable LazyPacketData message) {
        ...
        this.selectedTrades.addAll(message.getList("Selected",Integer.class));
