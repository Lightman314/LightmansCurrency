 ...
 * Normally not necessary, as most objects have their own ways of tracking which side they're on, but is useful for data that can be saved to an item stack via the {@link CapabilityMoneyHandler#MONEY_HANDLER_ITEM} capabilty<br>
 * and any objects that attempt to get a {@link IMoneyHandler IMoneyHandler} capability from an item should check for this interface
 */
