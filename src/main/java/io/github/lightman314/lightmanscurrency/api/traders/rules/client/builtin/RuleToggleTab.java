...
import io.github.lightman314.lightmanscurrency.api.traders.rules.client.TradeRulesClientSubTab;
...
public class RuleToggleTab extends TradeRulesClientSubTab implements IScrollable {
    ...
    public void renderBG(EasyGuiGraphics gui) {
        ...
        for(int i = 0; i < RULES_PER_PAGE; ++i)
        {
            ...
            if(index < rules.size())
            {
                ...
                IconRenderer.renderIcon(rule.getIcon(),gui, 30, 26 + (18 * i));
    ...
    void PressManagerActiveButton(int ruleIndex)
    {
        ...
        if(ruleIndex < rules.size())
        {
            ...
            this.commonTab.EditTradeRule(rule.getType(), this.builder().setBoolean("SetActive",!rule.isActive()));
        }
    }
