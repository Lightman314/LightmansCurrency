...
public class LCCodecs {
    ...
    public static final Codec<Notification> NOTIFICATION = easyCodec2(Notification::save, NotificationAPI.getApi()::LoadNotification, "Notification");
    ...
    public static final Codec<NotificationCategory> NOTIFICATION_CATEGORY = easyCodec2(NotificationCategory::save,NotificationAPI.getApi()::LoadCategory, "Notification Category");
