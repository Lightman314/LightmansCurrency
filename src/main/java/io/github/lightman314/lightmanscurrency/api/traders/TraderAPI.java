...
public abstract class TraderAPI {
     ...
     */
    public abstract boolean FilterTrade(TradeData trade, String searchText);
    /**
     * Filters the given list via {@link #FilterTrade(TradeData, String)} and returns the list of trades that have passed
     */
    
    public abstract List<TradeData> FilterTrades(List<TradeData> trades, String searchText);
