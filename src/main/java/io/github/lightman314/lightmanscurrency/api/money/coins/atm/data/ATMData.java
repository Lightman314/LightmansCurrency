...
public class ATMData {
	...
	private ATMData(JsonObject jsonData,ChainData chain,DataContext<JsonElement> context) throws JsonSyntaxException, ResourceLocationException {
	...
	public static ATMData parse(JsonObject json,ChainData chain,DataContext<JsonElement> context) throws JsonSyntaxException, ResourceLocationException { return new ATMData(json,chain,context); }
