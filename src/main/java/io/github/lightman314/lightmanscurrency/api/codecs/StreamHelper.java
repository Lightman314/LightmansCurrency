...
public final class StreamHelper {
    ...
    public static <T> StreamCodec<ByteBuf,T> byNameCodec(Function<ResourceLocation,T> valueGetter,Function<T,ResourceLocation> idGetter)
    {
        return ResourceLocation.STREAM_CODEC.map(valueGetter,idGetter);
    }

    public static <T> StreamCodec<ByteBuf,T> byNameCodec(Registry<T> registry)
    {
