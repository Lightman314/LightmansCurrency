...
public final class LCStreamHelpers {

    private LCStreamHelpers() {}
    ...
    public static <B extends ByteBuf,T> StreamCodec<B,T> byIDCodec(Registry<T> registry)
    {
        return StreamCodec.of((buffer,value) -> buffer.writeInt(registry.getId(value)),
                buffer -> registry.byId(buffer.readInt()));
    }
