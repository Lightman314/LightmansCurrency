...
import io.github.lightman314.lightmanscurrency.api.traders.rules.builtin.FreeSample;
...
public class FreeSampleTab extends TradeRuleSubTab<FreeSample> {
    ...
    public FreeSampleTab(TradeRulesClientTab<?> parent) { super(parent, FreeSample.TYPE); }
