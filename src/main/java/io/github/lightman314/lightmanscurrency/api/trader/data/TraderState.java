...
public enum TraderState {
    ...
    public static final Codec<TraderState> CODEC = EnumHelper.buildCodec(TraderState.class,"Trader State");
    ...
    public boolean isItem() { return this == HELD_AS_ITEM || this == ADMIN_HELD_AS_ITEM; }
    public boolean shouldEject() { return this == NORMAL || this == MOVED_BY_MACHINE; }

    public static TraderState heldItemState(Player player) { return LCApi.isInAdminMode(player) ? ADMIN_HELD_AS_ITEM : HELD_AS_ITEM; }
