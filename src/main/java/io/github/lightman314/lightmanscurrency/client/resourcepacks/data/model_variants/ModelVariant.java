...
public class ModelVariant {
    ...
    private Map<ResourceLocation,ResourceLocation> targetedItems = ImmutableMap.of();
    @ApiStatus.Internal
    ...
    public ResourceLocation getItem(@Nullable IVariantBlock target) {
        if(target == null)
            return this.getItem();
        ResourceLocation itemModel = this.targetedItems.get(target.getBlockID());
        return itemModel == null ? this.getItem() : itemModel;
    }
    @ApiStatus.Internal
    public void overrideItemModel(ResourceLocation modelID) { this.item = modelID; }
    public void defineTargetBasedItemModel(Map<ResourceLocation,ResourceLocation> targetedItems) { this.targetedItems = ImmutableMap.copyOf(targetedItems); }
    @Nullable
    ...
    @Nullable
    public ResourceLocation getStandaloneModel(@Nullable IVariantBlock target, int index)
    {
        return this.getModel(target,index);
        //return model == null ? null : new ModelResourceLocation(model,"standalone");
    }
