...
public class IconAndButtonUtil {
	...
	public static IconButton creativeToggleButton(int x, int y, Consumer<EasyButton> pressable, Supplier<Boolean> isCreative) { return new IconButton(x, y, pressable, IconUtil.ICON_CREATIVE(isCreative)).withAddons(EasyAddonHelper.toggleTooltip(isCreative, LCText.TOOLTIP_TRADER_SETTINGS_CREATIVE_DISABLE.get(), LCText.TOOLTIP_TRADER_SETTINGS_CREATIVE_ENABLE.get())); }
