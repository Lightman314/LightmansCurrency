...
public class RuleToggleTab extends TradeRulesClientSubTab {
    ...
    public void renderBG(@Nonnull PoseStack pose, int mouseX, int mouseY, float partialTicks) {
        ...
        this.font.draw(pose, Component.translatable("traderule.list.blurb").withStyle(ChatFormatting.BOLD), this.screen.getGuiLeft() + 20, this.screen.getGuiTop() + 10, 0xFFFFFF);
