...
public class SlotMachineStorageClientTab extends TraderStorageClientTab<SlotMachineStorageTab> implements IScrollListener, IScrollable, IMouseListener {
    ...
    public SlotMachineStorageClientTab(Object screen, SlotMachineStorageTab commonTab) { super(screen, commonTab); }
