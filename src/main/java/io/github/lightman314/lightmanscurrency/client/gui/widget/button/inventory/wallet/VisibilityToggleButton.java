...
public class VisibilityToggleButton extends InventoryButton {
    ...
    public static final FixedSizeSprite SPRITE_VISIBLE = new NormalSprite(SpriteSource.createBottom(LightmansCurrency.id("common/widgets/button_wallet_visibility"),6,6));
    public static final FixedSizeSprite SPRITE_INVISIBLE = new NormalSprite(SpriteSource.createTop(LightmansCurrency.id("common/widgets/button_wallet_visibility"),6,6));
