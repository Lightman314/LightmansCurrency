...
public class EjectionMenuButton extends InventoryButton {
    ...
    public static final FixedSizeSprite SPRITE = WidgetStateSprite.lazyHoverable(LightmansCurrency.id("common/widgets/button_ejection_menu"),10,10);
	...
	public EjectionMenuButton(AbstractContainerScreen<?> inventoryScreen) {
		super(inventoryScreen, CPacketOpenEjectionMenu::send, SPRITE);
		lastButton = this;
	}
