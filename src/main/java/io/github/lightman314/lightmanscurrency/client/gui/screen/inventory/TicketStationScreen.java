...
public class TicketStationScreen extends EasyMenuScreen<TicketStationMenu> implements IScrollable {
	...
	{
		if(this.selectedRecipe != null)
			return EasyText.translatable("gui.button.lightmanscurrency.craft_ticket", this.selectedRecipe.getResultItem(this.menu.blockEntity.getLevel().registryAccess()).getHoverName());
