...
public class TicketStationScreen extends EasyMenuScreen<TicketStationMenu> implements IScrollable {
    ...
    protected void initialize(ScreenArea screenArea)
    {
        this.addChild(PlainButton.builder()
                ...
                .sprite(SPRITE_ARROW)
                .addon(EasyAddonHelper.visibleCheck(() -> this.menu.validInputs() && this.selectedRecipe != null && this.selectedRecipe.validData(this.menu.getExtraData()) && this.menu.roomForOutput(this.selectedRecipe)))
    ...
    protected void renderBG(@Nonnull EasyGuiGraphics gui)
    {
        ...
        if(this.selectedRecipe != null)
            gui.renderItem(this.selectedRecipe.peekAtResult(this.menu.blockEntity.getStorage(),this.menu.getExtraData()), SELECTION_AREA.pos);
    ...
    protected void renderAfterWidgets(@Nonnull EasyGuiGraphics gui) {
        ...
        if(this.selectedRecipe != null && SELECTION_AREA.offsetPosition(this.getCorner()).isMouseInArea(gui.mousePos))
        {
            ...
            tooltip.add(LCText.TOOLTIP_TICKET_STATION_RECIPE_INFO.get(this.selectedRecipe.peekAtResult(this.menu.blockEntity.getStorage(),this.menu.getExtraData()).getHoverName()));
    ...
    public boolean codeInputVisible() { return this.selectedRecipe != null && this.selectedRecipe.requiredCodeInput(); }

    public boolean durabilityInputVisible() { return this.selectedRecipe != null && this.selectedRecipe.requiredDurabilityInput(); }

    private boolean canAddDurability() { return this.selectedRecipe != null && this.menu.getDurability() < this.selectedRecipe.getDurabilityData().max; }
    private boolean canRemoveDurability() {
        if(this.selectedRecipe == null)
            return false;
        DurabilityData data = this.selectedRecipe.getDurabilityData();
    ...
    {
        if(this.selectedRecipe != null)
            return LCText.TOOLTIP_TICKET_STATION_CRAFT.get(this.selectedRecipe.peekAtResult(this.menu.blockEntity.getStorage(),this.menu.getExtraData()).getHoverName());
    ...
    private int validateDurability(int value,boolean roundUp)
    {
        if(this.selectedRecipe == null)
            return value;
        return this.selectedRecipe.validateDurability(value,roundUp);
    }
    ...
    public void incrementDurability()
    {
        if(!this.durabilityInputVisible() || this.selectedRecipe == null)
            return;
        TicketStationRecipe r = this.selectedRecipe;
