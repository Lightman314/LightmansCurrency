...
public class CoinChestRenderer implements BlockEntityRenderer<CoinChestBlockEntity> {
    ...
    private final boolean xmaxTextures;

    public CoinChestRenderer(BlockEntityRendererProvider.Context context) {
        Calendar calendar = Calendar.getInstance();
        this.xmaxTextures = calendar.get(Calendar.MONTH) + 1 == 12 && calendar.get(Calendar.DATE) >= 24 && calendar.get(Calendar.DATE) <= 26;
    ...
    private Material getMaterial() { return this.xmaxTextures ? COIN_CHEST_MATERIAL_XMAS : COIN_CHEST_MATERIAL; }
