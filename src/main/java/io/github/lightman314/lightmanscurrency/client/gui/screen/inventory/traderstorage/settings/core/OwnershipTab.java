...
public class OwnershipTab extends SettingsSubTab {
    ...
    public void onOpen() {
        ...
        this.buttonSetOwner = this.addWidget(Button.builder(EasyText.translatable("gui.button.lightmanscurrency.set_owner"), this::setOwner).pos(this.screen.getGuiLeft() + 20, this.screen.getGuiTop() + 41).size(160, 20).build());
        ...
        this.buttonSetTeamOwner = this.addWidget(Button.builder(EasyText.translatable("gui.button.lightmanscurrency.set_owner"), this::setTeamOwner).pos(this.screen.getGuiLeft() + 20, this.screen.getGuiTop() + 130).size(160, 20).build());
