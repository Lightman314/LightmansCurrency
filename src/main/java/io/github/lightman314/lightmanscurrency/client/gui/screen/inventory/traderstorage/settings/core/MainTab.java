...
public class MainTab extends SettingsSubTab {
    ...
    public void onOpen() {
        ...
        this.nameInput = this.addWidget(new EditBox(this.font, this.screen.getGuiLeft() + 20, this.screen.getGuiTop() + 25, 160, 20, Component.empty()));
        this.nameInput.setMaxLength(32);
        this.nameInput.setValue(trader.getCustomName());

        this.buttonSetName = this.addWidget(Button.builder(Component.translatable("gui.lightmanscurrency.changename"), this::SetName).pos(this.screen.getGuiLeft() + 20, this.screen.getGuiTop() + 50).size(74, 20).build());
        this.buttonResetName = this.addWidget(Button.builder(Component.translatable("gui.lightmanscurrency.resetname"), this::ResetName).pos(this.screen.getGuiLeft() + this.screen.getXSize() - 93, this.screen.getGuiTop() + 50).size(74, 20).build());
        ...
        this.persistentTraderIDInput = this.addWidget(new EditBox(this.font, this.screen.getGuiLeft() + 37 + idWidth, this.screen.getGuiTop() + 140 - 30, 108 - idWidth, 18, Component.empty()));

        int ownerWidth = this.font.width(Component.translatable("gui.lightmanscurrency.settings.persistent.owner"));
        this.persistentTraderOwnerInput = this.addWidget(new EditBox(this.font, this.screen.getGuiLeft() + 12 + ownerWidth, this.screen.getGuiTop() + 140 - 55, 178 - ownerWidth, 18, Component.empty()));
