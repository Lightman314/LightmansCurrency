...
public class FreeSampleTab extends TradeRuleSubTab<FreeSample> {
    ...
    public void onOpen() {
        ...
        this.buttonClearMemory = this.addWidget(Button.builder(Component.translatable("gui.button.lightmanscurrency.free_sample.reset"), this::PressClearMemoryButton).pos(this.screen.getGuiLeft() + 10, this.screen.getGuiTop() + 60).size(screen.getXSize() - 20, 20).build());
