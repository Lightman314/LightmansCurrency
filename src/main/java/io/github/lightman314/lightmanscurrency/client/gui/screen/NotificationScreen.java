...
public class NotificationScreen extends EasyMenuScreen<NotificationMenu> {
	...
	public void markAsRead(EasyButton button) {
		this.menu.SendMessage(this.builder().setCompound("MarkAsRead", this.selectedCategory.save()));
	}
	...
	private void deleteNotification(int notificationIndex) {
		this.menu.SendMessage(this.builder().setInt("DeleteNotification",notificationIndex).setCompound("Category",this.selectedCategory.save()));
