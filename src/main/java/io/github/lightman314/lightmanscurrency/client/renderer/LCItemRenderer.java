...
public class LCItemRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    public static final IItemRenderProperties USE_LC_RENDERER = new IItemRenderProperties() {
        public BlockEntityWithoutLevelRenderer getItemStackRenderer() { return INSTANCE.get(); }
    };
    ...
    @Override
    public void renderByItem(@Nonnull ItemStack stack, @Nonnull ItemTransforms.TransformType context, @Nonnull PoseStack pose, @Nonnull MultiBufferSource buffer, int lightLevel, int id) {
