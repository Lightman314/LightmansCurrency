...
public class PlayerWhitelistTab extends TradeRuleSubTab<PlayerWhitelist> {
    ...
    public void onOpen() {
        ...
        this.nameInput = this.addWidget(new EditBox(this.font, this.screen.getGuiLeft() + 10, this.screen.getGuiTop() + 9, this.screen.getXSize() - 20, 20, EasyText.empty()));

        this.buttonAddPlayer = this.addWidget(EasyButton.builder(EasyText.translatable("gui.button.lightmanscurrency.whitelist.add"), this::PressWhitelistButton).pos(this.screen.getGuiLeft() + 10, this.screen.getGuiTop() + 30).size(78, 20).build());
        this.buttonRemovePlayer = this.addWidget(EasyButton.builder(EasyText.translatable("gui.button.lightmanscurrency.whitelist.remove"), this::PressForgetButton).pos(this.screen.getGuiLeft() + this.screen.getXSize() - 88, this.screen.getGuiTop() + 30).size(78, 20).build());
