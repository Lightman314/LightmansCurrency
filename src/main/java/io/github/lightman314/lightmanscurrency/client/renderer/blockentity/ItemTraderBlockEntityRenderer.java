...
public class ItemTraderBlockEntityRenderer implements BlockEntityRenderer<ItemTraderBlockEntity>{
	...
	public static Quaternion getRotation(float partialTicks) { return MathUtil.fromAxisAngleDegree(MathUtil.getYP(), (ItemTraderBlockEntityRenderer.getRotationTime() + partialTicks) * 2.0F); }
