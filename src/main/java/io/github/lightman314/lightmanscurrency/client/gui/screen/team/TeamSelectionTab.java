...
public class TeamSelectionTab extends TeamTab {
	...
	@Override
	public MutableComponent getTooltip() { return EasyText.translatable("tooltip.lightmanscurrency.team.selection"); }
	...
	public void initialize(ScreenArea screenArea, boolean firstOpen) {
		...
		this.newTeamName = this.addChild(new EditBox(this.getFont(), screenArea.x + 20, screenArea.y + 140, 160, 20, EasyText.empty()));
