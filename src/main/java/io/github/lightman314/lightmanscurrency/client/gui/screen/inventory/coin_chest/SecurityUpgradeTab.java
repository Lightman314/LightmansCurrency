...
public class SecurityUpgradeTab extends CoinChestTab.Upgrade {
    ...
    public void init() {
        ...
        this.buttonSetOwner = this.screen.addRenderableTabWidget(EasyButton.builder(EasyText.translatable("gui.button.lightmanscurrency.set_owner"), this::setOwner).pos(this.screen.getGuiLeft() + 10, this.screen.getGuiTop() + 39).size(this.screen.getXSize() - 20, 20).build());
        ...
        this.buttonSetTeamOwner = this.screen.addRenderableTabWidget(EasyButton.builder(EasyText.translatable("gui.button.lightmanscurrency.set_owner"), this::setTeamOwner).pos(this.screen.getGuiLeft() + 10, this.screen.getGuiTop() + 124).size(this.screen.getXSize() - 20, 20).build());
