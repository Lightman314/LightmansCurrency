...
public abstract class EasyTab<T extends IEasyScreen> implements IEasyScreen {
    ...
    @Override
    public final <W extends Widget> @NotNull W addRenderableOnly(@NotNull W renderable) {
        this.screen.addRenderableOnly(renderable);
        this.tabObjects.add(renderable);
        return renderable;
    }
    @Override
    public final <W extends Widget & GuiEventListener> @NotNull W addRenderableWidget(@NotNull W widget) {
