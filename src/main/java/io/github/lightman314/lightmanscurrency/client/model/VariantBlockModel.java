...
public class VariantBlockModel implements IDynamicBakedModel {
    ...
    @Override
    public TriState useAmbientOcclusion(BlockState state, ModelData data, RenderType renderType) { return this.getModel(data).useAmbientOcclusion(state,data,renderType); }
