...
public class TradeLimitTab extends TradeRuleSubTab<TradeLimit> {
    ...
    public void onOpen() {
        ...
        this.buttonSetLimit = this.addWidget(Button.builder(EasyText.translatable("gui.button.lightmanscurrency.playerlimit.setlimit"), this::PressSetLimitButton).pos(this.screen.getGuiLeft() + 41, this.screen.getGuiTop() + 19).size(40, 20).build());
        this.buttonClearMemory = this.addWidget(Button.builder(EasyText.translatable("gui.button.lightmanscurrency.playerlimit.clearmemory"), this::PressClearMemoryButton).pos(this.screen.getGuiLeft() + 10, this.screen.getGuiTop() + 50).size(this.screen.getXSize() - 20, 20).build());
