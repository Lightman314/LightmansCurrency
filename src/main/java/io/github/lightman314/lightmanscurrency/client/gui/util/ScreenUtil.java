...
public class ScreenUtil {
    ...
    public static boolean isMouseOver(int mouseX, int mouseY, IEasyScreen screen) { return isMouseOver(mouseX, mouseY, screen.getCorner(), screen.getXSize(), screen.getYSize()); }
    ...
    public static boolean isMouseOver(double mouseX, double mouseY, IEasyScreen screen) { return isMouseOver(mouseX, mouseY, screen.getCorner(), screen.getXSize(), screen.getYSize()); }
