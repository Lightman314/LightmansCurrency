...
public class ScreenUtil {
    ...
    public static boolean isMouseOver(int mouseX, int mouseY, IEasyScreen screen) { return isMouseOver(mouseX, mouseY, screen.guiLeft(), screen.guiTop(), screen.width(), screen.height()); }
    ...
    public static boolean isMouseOver(double mouseX, double mouseY, IEasyScreen screen) { return isMouseOver(mouseX, mouseY, screen.guiLeft(), screen.guiTop(), screen.width(), screen.height()); }
