	...
	public static void addCoinTooltips(ItemStack stack, List<Component> tooltip)
	{
		...
		if(coinData != null)
		{
			...
			case DEFAULT:
				...
				{
					tooltip.add(new TranslatableComponent("tooltip.lightmanscurrency.coinworth.up", upwardConversion.getSecond(), upwardConversion.getFirst().getName(new ItemStack(upwardConversion.getFirst())).getString()).withStyle(ChatFormatting.YELLOW));
				}
				break;
			case VALUE:
