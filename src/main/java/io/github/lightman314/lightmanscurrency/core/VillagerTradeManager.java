...
public class VillagerTradeManager {
	...
	public static Map<Integer,List<ItemListing>> getCashierTrades() {
		return ImmutableMap.of(
				...
				ImmutableList.of(
						//Farmer
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 4), new ItemStack(ModItems.COIN_COPPER, 5), new ItemStack(Items.BREAD, 6), 16, 1, 0.05f),
						//Fisherman
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 7), new ItemStack(Items.COD_BUCKET), 16, 1, 0.05f),
						//Shepherd
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 4), new ItemStack(Items.SHEARS), 12, 1, 0.05f),
						//Fletcher
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 8), new ItemStack(Items.ARROW, 16), 12, 1, 0.05f),
						//Librarian
						new EnchantedBookForCoinsTrade(1),
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 2), new ItemStack(Blocks.BOOKSHELF), 12, 1, 0.05f),
						//Cartographer
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD), new ItemStack(ModItems.COIN_IRON, 5), new ItemStack(Items.MAP), 12, 1, 0.05f),
						//Cleric
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON), new ItemStack(Items.REDSTONE), 12, 1, 0.05f),
						//Armorer
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 1), new ItemStack(ModItems.COIN_IRON, 6), new ItemStack(Items.IRON_LEGGINGS), 12, 1, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 1), new ItemStack(Items.IRON_BOOTS), 12, 1, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 1), new ItemStack(ModItems.COIN_IRON, 3), new ItemStack(Items.IRON_HELMET), 12, 1, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 2), new ItemStack(Items.IRON_CHESTPLATE), 12, 1, 0.05f),
						//Weaponsmith
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 6), new ItemStack(Items.IRON_AXE), 12, 1, 0.05f),
						new EnchantedItemForCoinsTrade(ModItems.COIN_IRON, 3, Items.IRON_SWORD, 12, 1, 0.05f, ENCHANTMENT_PRICE_MODIFIER),
						//Toolsmith
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON), new ItemStack(Items.STONE_AXE), 12, 1, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON), new ItemStack(Items.STONE_SHOVEL), 12, 1, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON), new ItemStack(Items.STONE_PICKAXE), 12, 1, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON), new ItemStack(Items.STONE_HOE), 12, 1, 0.05f),
						//Butcher
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 2), new ItemStack(Items.RABBIT_STEW), 12, 1, 0.05f),
						//Leatherworker (dyed armor only)
						//Mason
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 2), new ItemStack(Items.BRICK, 10), 16, 1, 0.05f)
						),
				2,
				ImmutableList.of(
						//Farmer
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 1), new ItemStack(Items.PUMPKIN_PIE, 4), 12, 5, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 6), new ItemStack(Items.APPLE, 4), 16, 5, 0.05f),
						//Fisherman
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 3), new ItemStack(Items.COD, 15), 16, 10, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 2), new ItemStack(Blocks.CAMPFIRE), 12, 5, 0.05f),
						//Shepherd
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 2), new ItemStack(Blocks.WHITE_WOOL), 16, 5, 0.05f),
						//Fletcher
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 4), new ItemStack(Items.BOW), 12, 5, 0.05f),
						//Librarian
						new EnchantedBookForCoinsTrade(5),
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 2), new ItemStack(Blocks.LANTERN), 12, 5, 0.05f),
						//Cartographer
						new ItemsForMapTrade(new ItemStack(ModItems.COIN_GOLD, 3), ConfiguredStructureTags.ON_OCEAN_EXPLORER_MAPS, "filled_map.monument", MapDecoration.Type.MONUMENT, 12, 5),
						//Cleric
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 2), new ItemStack(Items.LAPIS_LAZULI), 12, 5, 0.05f),
						//Armorer
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 4), new ItemStack(Blocks.BELL), 12, 5, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 9), new ItemStack(ModItems.COIN_COPPER, 5), new ItemStack(Items.CHAINMAIL_LEGGINGS), 12, 5, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 6), new ItemStack(ModItems.COIN_COPPER, 3), new ItemStack(Items.CHAINMAIL_BOOTS), 12, 5, 0.05f),
						//Weaponsmith (bell trade duplicate)
						//Toolsmith (bell trade duplicate)
						//Butcher
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 3), new ItemStack(Items.PORKCHOP, 6), 16, 5, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 3), new ItemStack(Items.COOKED_CHICKEN, 8), 16, 5, 0.05f),
						//Leatherworker (dyed armor only)
						//Mason
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 2), new ItemStack(Blocks.CHISELED_STONE_BRICKS, 4), 16, 5, 0.05f)
						),
				3,
				ImmutableList.of(
						//Farmer
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 1), new ItemStack(Items.COOKIE, 18), 18, 10, 0.05f),
						//Fisherman
						new EnchantedItemForCoinsTrade(ModItems.COIN_IRON, 2, Items.FISHING_ROD, 3, 10, 0.05f, ENCHANTMENT_PRICE_MODIFIER),
						//Shepherd (none)
						//Fletcher
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 7), new ItemStack(Items.CROSSBOW), 12, 10, 0.05f),
						//Librarian
						new EnchantedBookForCoinsTrade(10),
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 3), new ItemStack(Blocks.GLASS,4), 12, 10, 0.05f),
						//Cartographer
						new ItemsForMapTrade(new ItemStack(ModItems.COIN_GOLD, 4), ConfiguredStructureTags.ON_WOODLAND_EXPLORER_MAPS, "filled_map.mansion", MapDecoration.Type.MANSION, 12, 10),
						//Cleric
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD), new ItemStack(Blocks.GLOWSTONE), 12, 10, 0.05f),
						//Armorer
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 7), new ItemStack(ModItems.COIN_COPPER, 4), new ItemStack(Items.CHAINMAIL_HELMET), 12, 10, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 10), new ItemStack(ModItems.COIN_COPPER, 5), new ItemStack(Items.CHAINMAIL_CHESTPLATE), 12, 10, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 6), new ItemStack(Items.SHIELD), 12, 10, 0.05f),
						//Weaponsmith (none)
						//Toolsmith
						...
						new BasicItemListing(new ItemStack(ModItems.COIN_DIAMOND, 2), new ItemStack(ModItems.COIN_IRON, 1), new ItemStack(Items.DIAMOND_HOE), 3, 10, 0.05f),
						//Butcher (none)
						//Leatherworker (dyed armor only)
						//Mason
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 2), new ItemStack(Blocks.POLISHED_ANDESITE, 4), 16, 10, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 2), new ItemStack(Blocks.POLISHED_DIORITE, 4), 16, 10, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 2), new ItemStack(Blocks.POLISHED_GRANITE, 4), 16, 10, 0.05f)
						),
				4,
				ImmutableList.of(
						//Farmer
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 2), new ItemStack(Blocks.CAKE), 12, 15, 0.05f),
						...
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 5), new ItemStack(Items.CLOCK), 12, 15, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 2), new ItemStack(Items.COMPASS), 12, 15, 0.05f),
						//Cartographer
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD), new ItemStack(Items.ITEM_FRAME), 12, 15, 0.05f),
						//Cleric
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD), new ItemStack(Items.ENDER_PEARL), 12, 15, 0.05f),
						//Armorer
						...
						//Mason
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 2), new ItemStack(Blocks.TERRACOTTA, 1), 16, 15, 0.05f)
						),
				5,
				ImmutableList.of(
						//Farmer
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 15), new ItemStack(Items.GOLDEN_CARROT), 12, 30, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 2), new ItemStack(Items.GLISTERING_MELON_SLICE), 12, 30, 0.05f),
						//Fisherman (none)
						//Shepherd
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 5), new ItemStack(Items.PAINTING), 12, 30, 0.05f),
						//Fletcher
						new EnchantedItemForCoinsTrade(ModItems.COIN_IRON, 10, Items.CROSSBOW, 3, 15, 0.05f, ENCHANTMENT_PRICE_MODIFIER),
						//Librarian
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 1), new ItemStack(Items.NAME_TAG), 12, 30, 0.05f),
						//Cartographer
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 1), new ItemStack(Items.GLOBE_BANNER_PATTERN), 12, 30, 0.05f),
						//Cleric
						new BasicItemListing(new ItemStack(ModItems.COIN_EMERALD, 1), new ItemStack(Blocks.NETHER_WART, 12), 12, 30, 0.05f),
						new BasicItemListing(new ItemStack(ModItems.COIN_IRON, 5), new ItemStack(Items.EXPERIENCE_BOTTLE), 12, 30, 0.05f),
						//Armorer
						...
						new BasicItemListing(new ItemStack(ModItems.COIN_GOLD, 1), new ItemStack(Items.SADDLE), 12, 30, 0.05f),
						//Mason
	...
	private static class ItemsForMapTrade implements ItemListing
	{
		...
		public ItemsForMapTrade(ItemStack price1, ItemStack price2, TagKey<ConfiguredStructureFeature<?, ?>> destination, String displayName, MapDecoration.Type mapDecorationType, int maxUses, int xpValue)
		{
			this.price1 = price1;
			this.price2 = price2;
