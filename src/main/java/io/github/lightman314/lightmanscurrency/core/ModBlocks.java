...
public class ModBlocks {
	...
	*/
	 ...
	 */
	private static BlockItemSet<Colors> registerColored(String name, ItemGroup itemGroup, Supplier<Block> block, @Nullable Colors dontNameThisColor)
	{
		return registerColored(name, itemGroup, BlockItemType.DEFAULT, block, dontNameThisColor);
	}
	
	private static BlockItemSet<Colors> registerColored(String name, ItemGroup itemGroup, BlockItemType type, Supplier<Block> block, @Nullable Colors dontNameThisColor)
	{
