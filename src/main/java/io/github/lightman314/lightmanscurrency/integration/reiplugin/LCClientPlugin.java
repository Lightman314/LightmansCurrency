        ...
        registry.registerFocusedStack(((screen,mouse) -> {
            if(screen instanceof EasyMenuScreen<?> s)
            {
                ...
                if(fluid != null && !fluid.getFirst().isEmpty())
                {
                    ...
                    return CompoundEventResult.interruptTrue(EntryStack.of(VanillaEntryTypes.FLUID,dev.architectury.fluid.FluidStack.create(f.getFluid(),f.getAmount(),f.getTag())));
                }
            }
