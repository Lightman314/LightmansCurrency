...
public class BOPCustomWoodTypes {
    ...
    public static final WoodType REDWOOD = WoodType.builder("redwood", MODID).ofName("Redwood").ofColor(MapColor.TERRACOTTA_ORANGE).build();
    public static final WoodType MAHOGANY = WoodType.builder("mahogany", MODID).ofName("Mahogany").ofColor(MapColor.TERRACOTTA_PINK).build();
    public static final WoodType JACARANDA = WoodType.builder("jacaranda", MODID).ofName("Jacaranda").ofColor(MapColor.QUARTZ).build();
    public static final WoodType PALM = WoodType.builder("palm", MODID).ofName("Palm").ofColor(MapColor.TERRACOTTA_YELLOW).build();
    public static final WoodType WILLOW = WoodType.builder("willow", MODID).ofName("Willow").ofColor(MapColor.TERRACOTTA_LIGHT_GREEN).build();
    public static final WoodType DEAD = WoodType.builder("dead", MODID).ofName("Dead").ofColor(MapColor.STONE).build();
    public static final WoodType MAGIC = WoodType.builder("magic", MODID).ofName("Magic").ofColor(MapColor.COLOR_BLUE).build();
    public static final WoodType UMBRAN = WoodType.builder("umbran", MODID).ofName("Umbran").ofColor(MapColor.TERRACOTTA_BLUE).build();
    public static final WoodType HELLBARK = WoodType.builder("hellbark", MODID).ofName("Hellbark").ofColor(MapColor.TERRACOTTA_GRAY).build();
