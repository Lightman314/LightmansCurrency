...
public class BOPWoodTypes {
    ...
    public static final WoodType FIR = new ModdedWoodType("fir", MapColor.TERRACOTTA_WHITE, MODID);
    public static final WoodType REDWOOD = new ModdedWoodType("redwood", MapColor.TERRACOTTA_ORANGE, MODID);
    public static final WoodType MAHOGANY = new ModdedWoodType("mahogany", MapColor.TERRACOTTA_PINK, MODID);
    public static final WoodType JACARANDA = new ModdedWoodType("jacaranda", MapColor.QUARTZ, MODID);
    public static final WoodType PALM = new ModdedWoodType("palm", MapColor.TERRACOTTA_YELLOW, MODID);
    public static final WoodType WILLOW = new ModdedWoodType("willow", MapColor.TERRACOTTA_LIGHT_GREEN, MODID);
    public static final WoodType DEAD = new ModdedWoodType("dead", MapColor.STONE, MODID);
    public static final WoodType MAGIC = new ModdedWoodType("magic", MapColor.COLOR_BLUE, MODID);
    public static final WoodType UMBRAN = new ModdedWoodType("umbran", MapColor.TERRACOTTA_BLUE, MODID);
    public static final WoodType HELLBARK = new ModdedWoodType("hellbark", MapColor.TERRACOTTA_GRAY, MODID);
