...
public class FTBTeamOwner extends Owner {
    ...
    public static final OwnerType TYPE = OwnerType.create(ResourceLocation.fromNamespaceAndPath(LightmansCurrency.MODID,"ftbteams"),(tag,l) -> new FTBTeamOwner(tag.getUUID("Team")));
