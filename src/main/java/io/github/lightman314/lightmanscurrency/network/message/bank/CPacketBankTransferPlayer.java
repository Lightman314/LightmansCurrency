...
public class CPacketBankTransferPlayer extends ClientToServerPacket {
	...
	public CPacketBankTransferPlayer(String playerName, CoinValue amount) {
	...
	private static class H extends Handler<CPacketBankTransferPlayer>
	{
		@Nonnull
		@Override
		public CPacketBankTransferPlayer decode(@Nonnull FriendlyByteBuf buffer) { return new CPacketBankTransferPlayer(buffer.readUtf(), CoinValue.decode(buffer)); }
		@Override
