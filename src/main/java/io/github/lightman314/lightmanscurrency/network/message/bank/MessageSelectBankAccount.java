...
public class MessageSelectBankAccount {
	...
	public static void encode(MessageSelectBankAccount message, FriendlyByteBuf buffer) { message.account.encode(buffer); }

	public static MessageSelectBankAccount decode(FriendlyByteBuf buffer) { return new MessageSelectBankAccount(BankReference.decode(buffer)); }
