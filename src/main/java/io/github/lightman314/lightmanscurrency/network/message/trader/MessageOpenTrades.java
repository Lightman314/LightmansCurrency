...
public class MessageOpenTrades {
	...
	public MessageOpenTrades(long traderID) { this.traderID = traderID; }

	public static void encode(MessageOpenTrades message, FriendlyByteBuf buffer) { buffer.writeLong(message.traderID); }

	public static MessageOpenTrades decode(FriendlyByteBuf buffer) { return new MessageOpenTrades(buffer.readLong()); }
