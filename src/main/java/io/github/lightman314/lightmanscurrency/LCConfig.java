...
public final class LCConfig {
    ...
    public static final class Common extends ConfigFile
    {
        ...
        protected void setup(@Nonnull ConfigBuilder builder) {
            ...
            builder.comment("Whether custom events defined in the 'SeasonalEvent.json' config can give players a one-time reward for logging in during the event.")
    ...
    public static final class Server extends SyncedConfigFile
    {
        ...
        public final IntOption flanClaimingBlocksPerChunk = IntOption.create(256, 1, 64);
