...
public class ModCreativeGroups {
    ...
    public static final DeferredRegister<CreativeModeTab> REGISTER = DeferredRegister.create(BuiltInRegistries.CREATIVE_MODE_TAB, LightmansCurrency.MODID);

    public static final ResourceLocation COIN_GROUP_ID =LightmansCurrency.id("coins");
    public static final ResourceLocation MACHINE_GROUP_ID =LightmansCurrency.id("machines");
    public static final ResourceLocation TRADER_GROUP_ID =LightmansCurrency.id("traders");
    public static final ResourceLocation UPGRADE_GROUP_ID =LightmansCurrency.id("upgrades");

    public static final ResourceLocation EXTRA_GROUP_ID =LightmansCurrency.id( "extra");

    static {

        if(WoodType.hasModdedValues())
        {
            EXTRA_GROUP = register("extra", builder -> builder
    ...
    public static final Supplier<CreativeModeTab> COIN_GROUP = register("coins", builder -> builder
    ...
    public static final Supplier<CreativeModeTab> MACHINE_GROUP = register("machines", builder -> builder
    ...
    public static final Supplier<CreativeModeTab> TRADER_GROUP = register("traders", builder -> builder
    ...
    public static final Supplier<CreativeModeTab> UPGRADE_GROUP = register("upgrades", builder -> builder
            .withTabsBefore(TRADER_GROUP_ID)
    ...
    public static DeferredHolder<CreativeModeTab,CreativeModeTab> register(String id, UnaryOperator<CreativeModeTab.Builder> builder) {
        return REGISTER.register(id,() -> builder.apply(CreativeModeTab.builder()).build());
    }
