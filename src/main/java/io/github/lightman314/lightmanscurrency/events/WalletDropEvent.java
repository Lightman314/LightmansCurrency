...
public class WalletDropEvent extends PlayerEvent{
	...
	public WalletDropEvent(PlayerEntity entity, IWalletHandler walletHandler, DamageSource source, Collection<ItemEntity> walletDrops, boolean keepWallet, int coinDropPercent)
	{
		super(entity);
	...
	public WalletDropEvent(PlayerEntity entity, ItemStack walletStack, DamageSource source, Collection<ItemEntity> walletDrops, boolean keepWallet, int coinDropPercent)
	{
		super(entity);
